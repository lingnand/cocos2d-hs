...
module Graphics.UI.Cocos2d.Node (
  ...
  node_scheduleOnce,
  node_schedule,
  node_scheduleWithInterval,
  node_scheduleWithIntervalAndRepeat,
  node_unschedule,
  node_unscheduleAllCallbacks,
  node_resume,
  node_pause,
...
foreign import ccall "genpop__Node_getPositionX" node_getPositionX' ::  HoppyF.Ptr NodeConst -> HoppyP.IO HoppyFC.CFloat
foreign import ccall "genpop__Node_setPositionX" node_setPositionX' ::  HoppyF.Ptr Node -> HoppyFC.CFloat -> HoppyP.IO ()
foreign import ccall "genpop__Node_getPositionY" node_getPositionY' ::  HoppyF.Ptr NodeConst -> HoppyP.IO HoppyFC.CFloat
foreign import ccall "genpop__Node_setPositionY" node_setPositionY' ::  HoppyF.Ptr Node -> HoppyFC.CFloat -> HoppyP.IO ()
...
foreign import ccall "genpop__Node_schedule" node_schedule' ::  HoppyF.Ptr Node -> HoppyFHR.CCallback (HoppyFC.CFloat -> HoppyP.IO ()) -> HoppyF.Ptr M1.StdStringConst -> HoppyP.IO ()
foreign import ccall "genpop__Node_scheduleWithInterval" node_scheduleWithInterval' ::  HoppyF.Ptr Node -> HoppyFHR.CCallback (HoppyFC.CFloat -> HoppyP.IO ()) -> HoppyFC.CFloat -> HoppyF.Ptr M1.StdStringConst -> HoppyP.IO ()
foreign import ccall "genpop__Node_scheduleWithIntervalAndRepeat" node_scheduleWithIntervalAndRepeat' ::  HoppyF.Ptr Node -> HoppyFHR.CCallback (HoppyFC.CFloat -> HoppyP.IO ()) -> HoppyFC.CFloat -> HoppyFC.CUInt -> HoppyFC.CFloat -> HoppyF.Ptr M1.StdStringConst -> HoppyP.IO ()
foreign import ccall "genpop__Node_unschedule" node_unschedule' ::  HoppyF.Ptr Node -> HoppyF.Ptr M1.StdStringConst -> HoppyP.IO ()
foreign import ccall "genpop__Node_unscheduleAllCallbacks" node_unscheduleAllCallbacks' ::  HoppyF.Ptr Node -> HoppyP.IO ()
foreign import ccall "genpop__Node_resume" node_resume' ::  HoppyF.Ptr Node -> HoppyP.IO ()
foreign import ccall "genpop__Node_pause" node_pause' ::  HoppyF.Ptr Node -> HoppyP.IO ()
...
node_getPositionX :: (NodeValue arg'1) => arg'1 -> HoppyP.IO HoppyP.Float
node_getPositionX arg'1 =
  withNodePtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap HoppyP.realToFrac
  (node_getPositionX' arg'1')

node_getPositionY :: (NodeValue arg'1) => arg'1 -> HoppyP.IO HoppyP.Float
node_getPositionY arg'1 =
  withNodePtr arg'1 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'1' ->
  HoppyP.fmap HoppyP.realToFrac
  (node_getPositionY' arg'1')
...
node_setPositionX :: (NodePtr arg'1) => arg'1 -> HoppyP.Float -> HoppyP.IO ()
node_setPositionX arg'1 arg'2 =
  HoppyFHR.withCppPtr (toNode arg'1) $ \arg'1' ->
  let arg'2' = HoppyP.realToFrac arg'2 in
  (node_setPositionX' arg'1' arg'2')

node_setPositionY :: (NodePtr arg'1) => arg'1 -> HoppyP.Float -> HoppyP.IO ()
node_setPositionY arg'1 arg'2 =
  HoppyFHR.withCppPtr (toNode arg'1) $ \arg'1' ->
  let arg'2' = HoppyP.realToFrac arg'2 in
  (node_setPositionY' arg'1' arg'2')
...
node_isScheduled :: (NodePtr arg'1, M1.StdStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO HoppyP.Bool
node_isScheduled arg'1 arg'2 =
  HoppyFHR.withCppPtr (toNode arg'1) $ \arg'1' ->
  M1.withStdStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  HoppyP.fmap (/= 0)
  (node_isScheduled' arg'1' arg'2')

node_scheduleOnce :: (NodePtr arg'1, M1.StdStringValue arg'4) => arg'1 -> (HoppyP.Float -> HoppyP.IO ()) -> HoppyP.Float -> arg'4 -> HoppyP.IO ()
node_scheduleOnce arg'1 arg'2 arg'3 arg'4 =
  HoppyFHR.withCppPtr (toNode arg'1) $ \arg'1' ->
...
node_schedule :: (NodePtr arg'1, M1.StdStringValue arg'3) => arg'1 -> (HoppyP.Float -> HoppyP.IO ()) -> arg'3 -> HoppyP.IO ()
node_schedule arg'1 arg'2 arg'3 =
  HoppyFHR.withCppPtr (toNode arg'1) $ \arg'1' ->
  M2.scheduleCallback_new arg'2 >>= \arg'2' ->
  M1.withStdStringPtr arg'3 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'3' ->
  (node_schedule' arg'1' arg'2' arg'3')

node_scheduleWithInterval :: (NodePtr arg'1, M1.StdStringValue arg'4) => arg'1 -> (HoppyP.Float -> HoppyP.IO ()) -> HoppyP.Float -> arg'4 -> HoppyP.IO ()
node_scheduleWithInterval arg'1 arg'2 arg'3 arg'4 =
  HoppyFHR.withCppPtr (toNode arg'1) $ \arg'1' ->
  M2.scheduleCallback_new arg'2 >>= \arg'2' ->
  let arg'3' = HoppyP.realToFrac arg'3 in
  M1.withStdStringPtr arg'4 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'4' ->
...
node_scheduleWithIntervalAndRepeat :: (NodePtr arg'1, M1.StdStringValue arg'6) => arg'1 -> (HoppyP.Float -> HoppyP.IO ()) -> HoppyP.Float -> HoppyFC.CUInt -> HoppyP.Float -> arg'6 -> HoppyP.IO ()
node_scheduleWithIntervalAndRepeat arg'1 arg'2 arg'3 arg'4 arg'5 arg'6 =
  HoppyFHR.withCppPtr (toNode arg'1) $ \arg'1' ->
  M2.scheduleCallback_new arg'2 >>= \arg'2' ->
  let arg'3' = HoppyP.realToFrac arg'3 in
  let arg'4' = arg'4 in
...
node_unschedule :: (NodePtr arg'1, M1.StdStringValue arg'2) => arg'1 -> arg'2 -> HoppyP.IO ()
node_unschedule arg'1 arg'2 =
  HoppyFHR.withCppPtr (toNode arg'1) $ \arg'1' ->
  M1.withStdStringPtr arg'2 $ HoppyP.flip HoppyFHR.withCppPtr $ \arg'2' ->
  (node_unschedule' arg'1' arg'2')

node_unscheduleAllCallbacks :: (NodePtr arg'1) => arg'1 -> HoppyP.IO ()
node_unscheduleAllCallbacks arg'1 =
  HoppyFHR.withCppPtr (toNode arg'1) $ \arg'1' ->
  (node_unscheduleAllCallbacks' arg'1')

node_resume :: (NodePtr arg'1) => arg'1 -> HoppyP.IO ()
node_resume arg'1 =
  HoppyFHR.withCppPtr (toNode arg'1) $ \arg'1' ->
  (node_resume' arg'1')

node_pause :: (NodePtr arg'1) => arg'1 -> HoppyP.IO ()
node_pause arg'1 =
  HoppyFHR.withCppPtr (toNode arg'1) $ \arg'1' ->
  (node_pause' arg'1')
